...
| `strictexplicitness` | `ImplicitInstanceOutput` | 3 | — | Flags methods that assign, delete, or mutate instance or class state through `self` / `cls`. `__init__`, `__new__`, and `__post_init__` stay quiet. |
