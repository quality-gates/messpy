...
Issues and specs for this repo live in the `quality-gates/messpy` GitHub repository. Use the `gh` CLI for all operations.
...
The repository is `quality-gates/messpy`; `gh` infers this from the configured Git remote when run inside this clone.
